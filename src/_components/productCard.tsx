...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <div className="cardContainer flex min-w-60 flex-col saturate-50 duration-500 ease-in-out hover:z-20 hover:scale-105 hover:cursor-pointer hover:drop-shadow-2xl hover:saturate-100 hover:duration-300">
